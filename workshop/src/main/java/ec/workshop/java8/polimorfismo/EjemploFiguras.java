 ...
 */
package ec.workshop.java8.polimorfismo;
...
public class EjemploFiguras {
	...
	public static void main(String[] args) {
		...
		//Tanto la figura como el tama�o de la misma
		//son aleatorias :S
		for(int i = 0; i < 10; i++) {
		...
		for(Rectangulo r : listaFiguras) {
			...
			System.out.printf("Area de la figura: %f | Per�metro de la figura: %f %n", r.getArea(), r.getPerimetro());
			System.out.println("");
		}
