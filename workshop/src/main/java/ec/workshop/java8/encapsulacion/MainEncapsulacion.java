 ...
 * 
 */
package ec.workshop.java8.encapsulacion;

import ec.workshop.java8.encapsulacion.modelo.Persona;
import ec.workshop.java8.encapsulacion.servicio.Servicio;
import ec.workshop.java8.encapsulacion.utilidad.UtilsDni;
