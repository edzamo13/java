 ...
 * 
 */
package ec.workshop.java8.exampleabstract.ejemploabstractinterfaces;
...
public class Circulo extends ObjectoGrafico{
	...
	public void rotar() {
		...
		//Al rotar un c�rculo se queda igual
	...
	public void voltearHorizontal() {
		//No hay que hacer nada.
		//Al volter horizontalmente un c�rculo se queda igual
	}

	@Override
	public void voltearVertical() {
		//No hay que hacer nada.
		//Al volter verticalmente un c�rculo se queda igual		
	}
