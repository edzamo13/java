 ...
 */
package ec.workshop.java8.workshop.parking.utils;
...
public class Utils {
	...
	/*
	 * Este m�todo nos devuelve una instancia de LocalDateTime aleatoria,
	...
	/*
	 * Nos devuelve la duraci�n en minutos entre dos fechas
	 */
	public static int minutosEntreDosFechas(LocalDateTime anterior, LocalDateTime posterior) {
		// Le sumamos un minuto a posterior, ya que al usar el m�todo between, la fecha
		// m�s reciente es exclusiva.
	...
	public static int[] posicionNumeroPlaza(int n) {
		...
		// Este c�lculo tenemos que hacerlo por la forma
