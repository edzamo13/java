 ...
 * 
 */
package ec.workshop.java8.apistream.collectors;
...
//		
//		
//		// Podemos particionar en dos grupos, seg�n un predicado
		Map<Boolean, List<Empleado>> salarioMayorOIgualque32000 =
				empleados
					.stream()
					.collect(partitioningBy(e -> e.getSalario() >= 32000));
		
		System.out.println("EMPLEADOS AGRUPADOS POR EL CUMPLIMIENTO DE UNA FUNCI�N");
