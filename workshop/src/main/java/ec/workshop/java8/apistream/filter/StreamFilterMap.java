 ...
 * 
 */
package ec.workshop.java8.apistream.filter;
...
public class StreamFilterMap {
	...
	public static void main(String[] args) {
		...
		personas.put(2, new Persona("Jes�s", LocalDate.of(1931, 3, 13)));
		personas.put(3, new Persona("Miguel", LocalDate.of(1943, 8, 1)));
		personas.put(4, new Persona("Sim�n", LocalDate.of(1949, 5, 22)));
		...
		personas.put(8, new Persona("�ngel", LocalDate.of(1982, 10, 12)));
