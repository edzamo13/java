 ...
 * HUDIR LA FLOTA
 * 
 * Se trata de un juego cl�sico, en el que nos vamos a enfrentar al ordenador. Cada usuario dispone de un mapa
 * de 10x10 casillas, donde se colocar�n barcos (dos de tama�o 5, tres de tama�o 3, y cinco de tama�o 1). 
 * Jugador y ordenador ir�n diciendo posiciones en el mapa, y el jugador opuesto tendr� que indicar si la "bomba"
 * ha ca�do en el agua, o ha tocado alg�n barco.
 * 
 * Para simplificar el juego, en lugar de verificar si un barco completo se ha hundido, y cuantos barcos quedan a flote,
 * contabilizamos el n�mero total de casillas correspondientes a un barco que no han sido "hundidas". Se parte con
 * 24 puntos (5+5+3+3+3+1+1+1+1+1) 
 * 
 * Este c�digo est� inspirado (aunque reescrito y simplificado) de un c�digo original de Manuel Jes�s Gallego Vela
 */
