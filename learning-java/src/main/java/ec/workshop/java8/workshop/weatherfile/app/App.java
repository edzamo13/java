 ...
 * 
 */
package ec.workshop.java8.workshop.weatherfile.app;

import ec.workshop.java8.workshop.weatherfile.io.MeteoReader;
import ec.workshop.java8.workshop.weatherfile.model.RegistroDatos;
import ec.workshop.java8.workshop.weatherfile.model.TemperaturaHora;
import ec.workshop.java8.workshop.weatherfile.service.ServicioClimatologia;
import ec.workshop.java8.workshop.weatherfile.util.PrintUtil;
...
public class App {
	...
	private static void imprimirInformeMeteorologico(String fecha) {
		...
		System.out.printf("DATOS METEOROL�GICOS DEL D�A %s%n", fecha.toUpperCase());
		System.out.println("**************************************************\n\n");
		maximaYMinimaTotal();
		maximaPorProvincias();
		minimaPorProvincias();
