 ...
 * 
 */
package ec.workshop.java8.workshop.bdd.rows.jdbcrowset;

import ec.workshop.java8.workshop.bdd.rows.connection.DBConnection;
...
//			});
			...
			rowSet.updateString("nombre", "�ngel");
