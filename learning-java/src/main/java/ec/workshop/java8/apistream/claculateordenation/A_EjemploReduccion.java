...
public class A_EjemploReduccion {
	...
	public static void main(String[] args) {
		...
		// Reducimos el stream para quedarnos solamente con el m�ximo
		OptionalInt maximo = Arrays.stream(array).reduce(Integer::max);	

		String mensajeMaximo = maximo.isPresent() ?"El valor m�ximo es " + maximo.getAsInt() : "No hay valor m�ximo";
